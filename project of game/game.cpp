...
void printShip(char ship[][5], int &shipX, int &shipY);
void eraseShip(int &shipX, int &shipY);
void printMaze(); // print the maze
void moveBullet();
void generateBullet(int &shipX, int &shipY);
void removeBulletFromArray(int index);
void moveShipUp(char ship[][5], int &shipX, int &shipY);
void moveShipDown(char ship[][5], int &shipX, int &shipY);
void moveShipLeft(char ship[][5], int &shipX, int &shipY);
void moveShipRight(char ship[][5], int &shipX, int &shipY);
// Enemy1 functions
void moveEnemy(char enemy[2][5], int &enemyX, int &enemyY);
void printEnemy(char enemy[2][5], int &enemyX, int &enemyY);
void eraseEnemy(int &enemyX, int &enemyY);
// enemy2 functions
void moveenemy1(char enemy[2][5], int &enemy1X, int &enemy1Y);
void printenemy1(char enemy[2][5], int &enemy1X, int &enemy1Y);
void eraseenemy1(int &enemy1X, int &enemy1Y);
// enemy3 functions
void moveenemy2(char enemy[2][5], int &enemy2X, int &enemy2Y);
void printenemy2(char enemy[2][5], int &enemy2X, int &enemy2Y);
void eraseenemy2(int &enemy2X, int &enemy2Y);
// enemy1 bullets
void printenemybullet(int, int, int &shipX, int &shipY, int &enemyX, int &enemyY);
void eraseenemybullet(int, int, int &enemyX, int &enemyY);
void removeenemybulletfromarray(int);
void moveenemybullet();
void generateenemybullet(int &enemyX, int &enemyY);
void enemybulletcollisionwithplayer(int &shipX, int &shipY, int &enemyX, int &enemyY);
// enemy2 bullets
void generateenemy1bullet(int &enemy1X, int &enemy1Y);
void moveenemy1bullet();
void enemy1bulletcollisionwithplayer(int &shipX, int &shipY);
void printenemy1bullet(int, int);
void eraseenemy1bullet(int, int);
void removeenemy1bulletfromarray(int);
// enemy3 bullets
void generateenemy2bullet(int &enemy2X, int &enemy2Y);
void printenemy2bullet(int, int);
void eraseenemy2bullet(int, int);
void moveenemy2bullet();
void removeenemy2bulletfromarray(int);
void enemy2bulletcollisionwithplayer(int &shipX, int &shipY);
// big enemy  functions including bullets
void printbigenemy(char bigEnemy1[3][3], int &bigEnemyX);
void erasebigenemy(int &bigEnemyX);
void moveBigEnemy(char bigEnemy1[3][3], int &bigEnemyX);
void eraseBigBulletFromArray(int);
void generateBigEnemyBullet(int &bigEnemyX);
void bigBulletCollisionWithPlayer(int &shipX, int &shipY);
void moveBigBullet();
...
void moveSmartEnemy(int &shipX, int &shipY);
float distance(int, int, int &shipX, int &shipY);
// details funnction
...
void printhealth();
// player functions
void bulletCollisionWithEnemy(int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX);
void printBullet(int x, int y);
void eraseBullet(int x, int y);
void printBigBullet(int, int);
void eraseBigBullet(int, int);
void playerCollisionWithEnemy(char ship[][5], int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y);
// other functions
void gameInterface(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX); // function where game starts
void header();
...
void writeScore(int);
void loadScore();
void writeRecord(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX);
void loadRecord(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX);
int largestScore();
string gameOption();
void startGame();
void newGame(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX);
...
void loadBigBullet() // load of bullets
{
    fstream file;
...
void writeEnemyBullet() // write on file in bullets
{
    fstream file;
...
void loadEnemyBullet() // load enemy bullet function
{
    fstream file;
...
void writePlayerBullet() // write player  bullets function
{
    fstream file;
...
void loadPlayerBullet() // load player functions
{
    fstream file;
...
// new game function
void newGame(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX)
{
    smartEnemyX = 54;
    smartEnemyY = 3;
    smartHealth = 10;
    ...
    eraseEnemy2 = true;
    eraseEnemy3 = true;
    gameInterface(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y, enemy2X, enemy2Y, bigEnemyX);
}
// start game function
void startGame()
{
    ...
    while (option != "3")
    {
        ...
        if (option == "1")
        {
            if ((life == 0 || collision == true) || (healthofbigenemy == 0))
            {
                ...
                deletePlayerBullet();
                newGame(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y, enemy2X, enemy2Y, bigEnemyX);
            }
            else
            {
                loadRecord(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y, enemy2X, enemy2Y, bigEnemyX);
                if (healthofenemy1 != 0)
                {
                    loadEnemyBullet();
                }
...
// movement of first enemy function
void moveSmartEnemy(int &shipX, int &shipY)
{
    float left = distance(smartEnemyX - 1, smartEnemyY, shipX, shipY);
    float right = distance(smartEnemyX + 1, smartEnemyY, shipX, shipY);
    float up = distance(smartEnemyX, smartEnemyY - 1, shipX, shipY);
    float down = distance(smartEnemyX, smartEnemyY + 1, shipX, shipY);
...
float distance(int x, int y, int &shipX, int &shipY) // distance formula
{
    return sqrt(pow(shipX - x, 2) + pow(shipY - y, 2));
}

void printSmartEnemy() // print function
{
    colorontext(1);
...
void eraseSmartEnemy()//erase smart enemy
{
    gotoxy(smartEnemyX, smartEnemyY);
    cout << " ";
}

void eraseRandomEnemy1()//erase random enemy 1
{
    gotoxy(randomEnemy1X, randomEnemy1Y);
    cout << " ";
}
void eraseRandomEnemy2()//erase random enemy 2
{
...
void printRandomEnemy1()//print random enemy 1
{
    colorontext(4);
    gotoxy(randomEnemy1X, randomEnemy1Y);
    cout << randomEnemy;
...
void printRandomEnemy2()// print random enemy2
{
    colorontext(4);
    gotoxy(randomEnemy2X, randomEnemy2Y);
    cout << randomEnemy;
...
void eraseLifeChar()//erase life char
{
    gotoxy(58, 16);
    cout << " ";
}
int printLifeChar()//print life char
{
    if (lifeRandom == true)
    {
        randomValue = rand() % 4;
...
void playerCollisionWithEnemy(char ship[][5], int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX)
{
...
void gameInterface(int &shipX, int &shipY, int &enemyX, int &enemyY, int &enemy1X, int &enemy1Y, int &enemy2X, int &enemy2Y, int &bigEnemyX)
{
    int bulletSlowCount=0;
    ...
    while (true)
    {
        ...
        {
            moveShipLeft(ship, shipX, shipY);
        }
        if (GetAsyncKeyState(VK_RIGHT))
        {
            moveShipRight(ship, shipX, shipY);
        }
        if (GetAsyncKeyState(VK_UP))
        {
            moveShipUp(ship, shipX, shipY);
        }
        if (GetAsyncKeyState(VK_DOWN))
        {
            moveShipDown(ship, shipX, shipY);
        }
        if (GetAsyncKeyState(VK_ESCAPE) || (health == 0 && life == 0) || healthofbigenemy == 0)
        {
            break;
        }
        if(bulletSlowCount==4)
        {
        if (GetAsyncKeyState(VK_SPACE))
        {
            
            generateBullet(shipX, shipY);
        ...
        if (enemy1Active == false && enemy2Active == false && enemy3Active == false && bigEnemy == true)
        {
            if (printBig == true)
            {
                printbigenemy(bigEnemy1, bigEnemyX);
                printBig = false;
                printRandomEnemy1();
                printRandomEnemy2();
                printSmartEnemy();
            ...
            if (timer7 == 12)
            {
                ...
                generateBigEnemyBullet(bigEnemyX);
                timer7 = 0;
            }
            timer7++;
            moveBigBullet();
            ...
            moveBigEnemy(bigEnemy1, bigEnemyX);
            if (eraseSmart == true)
            {
                if (timerSmart == 4)
                {
                    moveSmartEnemy(shipX, shipY);
                    timerSmart = 0;
                }
                timerSmart++;
            }
        ...
        if (enemy1Active == true)
        {
            ...
            {
                generateenemybullet(enemyX, enemyY);
                timerEnemyBullet1 = 0;
            }
            if (timer == 3)
            {
                moveEnemy(enemy, enemyX, enemyY);
                timer = 0;
            }
        }
        if (enemy2Active == true)
        {
            if (timer2 == 20)
            {
                generateenemy1bullet(enemy1X, enemy1Y);
                timer2 = 0;
            }
            if (timer4 == 3)
            {
                moveenemy1(enemy, enemy1X, enemy1Y);
                timer4 = 0;
            }
        }
        if (life > 0 && health <= 0)
        ...
        if (enemy3Active == true)
        {
            if (timer3 == 20)
            {
                generateenemy2bullet(enemy2X, enemy2Y);
                timer3 = 0;
            }
            if (timer5 == 3)
            {
                moveenemy2(enemy, enemy2X, enemy2Y);
                timer5 = 0;
            }
        }
        if (healthofenemy1 == 0)
        ...
        if (timerLife >= 350)
        {
            ...
            if (result == 0)
            {
                if ((shipX + 5 == 58 && (shipY == 16 || shipY + 1 == 16)) || ((shipX == 58 || shipX + 1 == 58 || shipX + 2 == 58 || shipX + 3 == 58 || shipX + 4 == 58) && (shipY + 2 == 16)) || ((shipX - 1 == 58) && (shipY == 16 || shipY + 1 == 16)) || ((shipX == 58 || shipX + 1 == 58 || shipX + 2 == 58 || shipX + 3 == 58 || shipX + 4 == 58) && (shipY == 16)))
                {
                    eraseLifeChar();
                    timerLife = 0;
                    if (life < 4 && life >= 0)
            ...
            if (result == 1)
            {
                if ((shipX + 5 == 67 && (shipY == 7 || shipY + 1 == 7)) || ((shipX == 67 || shipX + 1 == 67 || shipX + 2 == 67 || shipX + 3 == 67 || shipX + 4 == 67) && (shipY + 2 == 7)) || ((shipX - 1 == 67) && (shipY == 7 || shipY + 1 == 7)) || ((shipX == 67 || shipX + 1 == 67 || shipX + 2 == 67 || shipX + 3 == 67 || shipX + 4 == 67) && (shipY == 7)))
                {
                    gotoxy(67, 7);
                    cout << " ";
                    timerLife = 0;
            ...
            if (result == 2)
            {
                if ((shipX + 5 == 22 && (shipY == 5 || shipY + 1 == 5)) || ((shipX == 22 || shipX + 1 == 22 || shipX + 2 == 22 || shipX + 3 == 22 || shipX + 4 == 22) && (shipY + 2 == 5)) || ((shipX - 1 == 5) && (shipY == 5 || shipY + 1 == 5)) || ((shipX == 22 || shipX + 1 == 22 || shipX + 2 == 22 || shipX + 3 == 22 || shipX + 4 == 22) && (shipY == 5)))
                {
                    gotoxy(22, 5);
                    cout << " ";
                    timerLife = 0;
            ...
            if (result == 3)
            {
                if ((shipX + 5 == 2 && (shipY == 5 || shipY + 1 == 5)) || ((shipX == 2 || shipX + 1 == 2 || shipX + 2 == 2 || shipX + 3 == 2 || shipX + 4 == 2) && (shipY + 2 == 5)) || ((shipX - 1 == 2) && (shipY == 5 || shipY + 1 == 5)) || ((shipX == 2 || shipX + 1 == 2 || shipX + 2 == 2 || shipX + 3 == 2 || shipX + 4 == 2) && (shipY == 5)))
                {
                    gotoxy(2, 5);
                    cout << " ";
                    timerLife = 0;
        ...
        moveenemy1bullet();
        moveenemy2bullet();
        enemy2bulletcollisionwithplayer(shipX, shipY);
        enemy1bulletcollisionwithplayer(shipX, shipY);
        enemybulletcollisionwithplayer(shipX, shipY, enemyX, enemyY);
        bigBulletCollisionWithPlayer(shipX, shipY);
        moveBullet();
        bulletCollisionWithEnemy(enemyX, enemyY, enemy1X, enemy1Y, enemy2X, enemy2Y, bigEnemyX);
        playerCollisionWithEnemy(ship, shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y, enemy2X, enemy2Y, bigEnemyX);
        timer++;
        timerEnemyBullet1++;
        timer2++;
        timer3++;
    ...
    writeBigBullet();
    writeEnemyBullet();
    writeRecord(shipX, shipY, enemyX, enemyY, enemy1X, enemy1Y, enemy2X, enemy2Y, bigEnemyX);
    system("cls");
    printGameOver();
    int largest = 0;
...
void optionInterface()
{
    ...
    while (option != "3")
    {
        ...
        if (option == "2")
        {
            ...
            cout << "If payer hit enemy health become zero and if life and health become zero than you lose." << endl
                 << "If you kill all three enemy and also big enemy than you won the game" << endl;
            clearscreen();
        }
    }
}
