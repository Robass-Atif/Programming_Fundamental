...
string doctor_passwords[userarrsize];
int doctorsalary[userarrsize];
...
bool validationOfDeleteEmptyAppointment(string);
// store functions
...
void storepatientreviews(string, int);
...
// validation in which patient do not enter review again
bool sameReview(int index)
{
    if (reviews[index] == "")
    {
        return true;
...
// validation for do not delete  appointment which was not added
bool validationOfDeleteEmptyAppointment(string name)
{
    bool check=false;
...
void rewritedoctordata()
{
    ...
    for (int i = 0; i < doctorusercount; i++)
    {
        if (i > 0)
        {
            file << endl;
            file << doctor[i] << ",";
            file << doctor_passwords[i] << ",";
            file << to_string(doctorsalary[i]) << ",";
            file << doctorfee[i];
        }
        else
        {
...
void sortingofarraydoctor()
{
    for (int i = 0; i < doctorusercount; i++)
    {
        ...
        string temp3 = doctor_passwords[i];
        doctor_passwords[i] = doctor_passwords[index];
        doctor_passwords[index] = temp3;
    }
}
void sortingofarraypatient()
{
...
void storepatientreviews(string review, int index)
{
    fstream file;
...
void loadpatientreviews()
{
    ...
    {
        getline(file, line);
        index = stoi(getfielddata(line, 1));
        reviews[index] = getfielddata(line, 2);
        reviewcount++;
    }
    }
    file.close();
...
void loaddoctordata()
{
    ...
    while (!file.eof())
    {
        ...
        doctorsalary[doctorusercount] = stoi(getfielddata(line, 3));
...
bool reviewsaved(string review, int index)
{
...
bool salarycheck(string name, string salary)
{
    ...
    if (check1 == true)
    {
        for (int index = 0; index < doctorusercount; index++)
        {
            ...
            {
                doctorsalary[index] = stoi(salary);
                return true;
            }
        }
    }
...
void doctorinterface()
{
    ...
    while (doctoroption != "10")
    {
        ...
        if (doctoroption == "4")
        {
            ...
            cout << "enter patient name: ";
            cin >> name;
            bool check1 = validationOfDeleteEmptyAppointment(name);
            if ( check1 == false)
            {
    ...
    while (patientoption != "7")
    {
        ...
        if (patientoption == "5")
        {
            ...
            if (check3 == true)
            {
                ...
                cin.ignore();
                getline(cin, review);
                bool check1 = reviewsaved(review, check);
                if (check1 == true)
                {
                    storepatientreviews(review, check);
            ...
            {
                colorontext(4);
                cout << " Sorry!you have already given a review " << endl;
                colorontext(7);
            }
            clearscreen();
        }
...
bool logindoctor(string name, string password)
{
    for (int index = 0; index < doctorusercount; index++)
    {
        if ((doctor[index] == name) && (doctor_passwords[index] == password))
        {
            return true;
        }
    }
...
bool doctoradd(string name, string password, string salary, string fee)
{
    ...
    if (check1 == true && check3 == true && check2 == true && check4 == true)
    {
        ...
        if (doctorusercount < userarrsize)
        {
            ...
            doctorsalary[doctorusercount] = stoi(salary);
...
void admininterface()
{
    ...
    while (adminoption != "9")
    {
        ...
        if (adminoption == "5")
        {
            ...
            for (int index = 0; index < patientusercount; index++)
            {
                cout << index + 1 << "." << patient[index] << "\t\t" << reviews[index] << endl;
            }
            clearscreen();
        }
        ...
        if (adminoption == "1")
        {
            ...
            for (int index = 0; index < doctorusercount; index++)
            {
                cout << index + 1 << "."
                     << "\t" << doctor[index] << "\t"
                     << "\t" << doctor_passwords[index] << "\t\t" << doctorsalary[index] << "\t\t" << doctorfee[index] << endl;
            }
        ...
        if (adminoption == "4")
        {
            ...
            cout << endl
                 << endl;
            string name;
            cout << "enter doctor name whic you want to delete: ";
            cin >> name;
